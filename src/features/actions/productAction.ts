...
export const detailsProduct = (id:any) => async (dispatch:any) => {
  try {
...
export const createProduct = (productData:any) => async (dispatch:any, getState:any) => {
  const {
    userSignin: { userInfo },
  } = getState();
...
export const updateProduct =
  (id:any, productData:any) => async (dispatch:any, getstate:any) => {
    const {
      userSignin: { userInfo },
    } = getstate();
...
export const deleteProduct = (productId:any) => async (dispatch:any, getState:any) => {
