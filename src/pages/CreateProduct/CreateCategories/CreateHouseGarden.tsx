...
function CreateHouseGarden(props: any) {
  ...
  const [mainCategorySelect, setMainCategorySelect] = useState("houseAndGarden")
  const [name, setName] = useState("")
  const [mainCategory, setMainCategory] = useState("houseAndGarden")
    ...
    <div className="form-container">
      ...
      <Form onSubmit={handleSubmit} className="form-container" encType="multipart/form-data">
        <div className="create-form-categories">
            ...
            <div className="dropdown">
              ...
              <div className="dropdown-content">
                {categoryArray.map((c: any, index) => (
                  <Link
                    to={"/createProduct/houseAndGarden"}
                    onClick={() => {
                      setCategorySelect(c)
                      setSubCategorySelect("Select Sub Category")
                      setCategory(c)
          ...
          {(categorySelect === "furnitureDecorations" ||
            categorySelect === "garden" ||
            categorySelect === "constructionFurnitureMaterials" ||
            categorySelect === "thermalElectricalSanitary" ||
            categorySelect === "toolsWroughtIronWork" ||
        ...
        {/* Below there was contolid='price' */}
        <Form.Group className="mb-3">
        ...
        {/* Below there was contolid='countInStock' */}
        <Form.Group className="mb-3">
