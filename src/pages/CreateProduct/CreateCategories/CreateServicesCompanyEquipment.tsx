...
function CreateServicesCompanyEquipment(props: any) {
  ...
  const [mainCategorySelect, setMainCategorySelect] = useState("servicesCompanyEquipment")
        ...
        {mainCategorySelect === "servicesCompanyEquipment" && (
          <div className="servicesCompanyEquipment-create-selectors">
            <section className="mainCategoryCreate">
              ...
              <div className="dropdown">
                <button className="dropbtn" type="button">
                  {experience === "" ? "Select Experience" : addUpperSpace(experience)}
                  <span>
                    <BiChevronDown className="icon-style" />
                  </span>
                </button>
                <div className="dropdown-content">
                  {experienceArray.map((c: any, index) => (
                    <Link
                      to={"/createProduct/servicesCompanyEquipment"}
                      onClick={() => {
                        setExperience(c)
            ...
            <section className="mainCategoryCreate">
              ...
              <div className="dropdown">
                <button className="dropbtn" type="button">
                  {availability === "" ? "Select Availability" : addUpperSpace(availability)}
                  <span>
                    <BiChevronDown className="icon-style" />
                  </span>
                </button>
                <div className="dropdown-content">
                  {availabilityArray.map((c: any, index) => (
                    <Link
                      to={"/createProduct/servicesCompanyEquipment"}
                      onClick={() => {
                        setAvailability(c)
            ...
            <section className="mainCategoryCreate">
              ...
              <div className="dropdown">
                <button className="dropbtn" type="button">
                  {guarantee === "" ? "Select Guarantee" : addUpperSpace(guarantee)}
                  <span>
                    <BiChevronDown className="icon-style" />
                  </span>
                </button>
                <div className="dropdown-content">
                  {guaranteeArray.map((c: any, index) => (
                    <Link
                      to={"/createProduct/servicesCompanyEquipment"}
                      onClick={() => {
                        setGuarantee(c)
