...
import { deleteProduct } from "../../features/actions/productAction"
...
import ProductSpecifications from "../ProductDetails/ProductSpecification"

function Product(props: any) {
  const deleteToast = () => toast.success("Product deleted successfully!")
  ...
  return (
    <div className="product">
      ...
      <i
        ...
        onClick={() => navigate(`/${product._id}/editProduct/${product.mainCategory}`)}
      ></i>
            ...
            <Carousel variant="dark">
              {product.images.map((img: any, index: any) => (
                <Carousel.Item className="slide-show-image">
                  <img className="ad-image" src={img.url} alt={img} key={index} />
                </Carousel.Item>
              ))}
            </Carousel>
