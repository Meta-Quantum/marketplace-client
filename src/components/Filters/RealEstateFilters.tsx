...
function RealEstateFilters(props: any) {
                  ...
                  <span>
                    {maxLandAreaSelected === "To" ? (
                      ...
                      <Link to={getFilterUrl({ maxLandArea: 0 })}>
                        <BiX className="icon-style" onClick={() => setMaxLandAreaSelected("To")} />
                      </Link>
                    )}
                  </span>
                </button>
                  ...
                  <span>
                    {maxBuiltAreaSelected === "To" ? (
                      ...
                      <Link to={getFilterUrl({ maxBuiltArea: 0 })}>
                        <BiX className="icon-style" onClick={() => setMaxBuiltAreaSelected("To")} />
                      </Link>
                    )}
                  </span>
                </button>
      ...
      {category === "parkingGarage" && (
        <>
          <section className="capacity">
            ...
            {/* Below there was controlid='capacity' */}
          ...
          <section className="type">
            ...
            {/* Below there was controlid='type' */}
            <div className="dropdown">
              <button className="dropbtn">
      ...
      {(category === "housesForRent" ||
        ...
        <>
          <section className="furnished">
            ...
            {/* Below there was controlid='furnished' */}
            <div className="dropdown">
              <button className="dropbtn">
          ...
          <section className="floor">
            ...
            {/* Below there was controlid='floor' */}
            <div className="dropdown">
              <button className="dropbtn">
                {addUpperSpace(floor)}
                <span>
          ...
          <section className="compartimentType">
            ...
            {/* Below there was controlid='compartimentType' */}
            <div className="dropdown">
              <button className="dropbtn">
          ...
          <section className="rooms">
            ...
            {/* Below there was controlid='rooms' */}
            <div className="dropdown">
              <button className="dropbtn">
                {addUpperSpace(rooms)}
                <span>
      ...
      {category === "officesCommercialSpaces" && (
        <>
          ...
          <section className="commerceType">
            ...
            {/* Below there was controlid='commerceType' */}
            <div className="dropdown">
              <button className="dropbtn">
      ...
      {category === "grounds" && (
        <>
          <section className="groundType">
            ...
            {/* Below there was controlid='groundType' */}
            <div className="dropdown">
              <button className="dropbtn">
