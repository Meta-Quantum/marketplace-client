...
function Header() {
  const userSignin = useAppSelector((state: any) => state.userSignin)
  const { userInfo } = userSignin
  const dispatch = useAppDispatch()
  const signoutHandler: any = () => {
    dispatch(signout())
  }
        ...
        <div className="first-nav">
          <div className="logo-position">
            <Link to="/" style={{ textDecoration: "none" }}>
              <img className="logo" src={logodark} alt="metaquantum icon" />
            </Link>
          </div>
          <SearchBox />
              ...
              <div className="login-register">
                ...
                {userInfo && !userInfo.isSeller && !userInfo.isAdmin && (
                  <>
                    ...
                    <div>{userInfo.name}</div>
                    {/* </Link> */}
                    <Link to="#signout" style={{ textDecoration: "none" }} onClick={signoutHandler}>
                      <div>Logout</div>
                    </Link>
                  </>
                )}
        ...
        <div className="second-nav">
          <div className="shop-department">
            ...
            <section className="mainCategory">
              {/* Below was controlid='mainCategory */}
