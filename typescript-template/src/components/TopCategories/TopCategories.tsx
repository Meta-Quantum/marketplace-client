      ...
      <label>
        ...
        <div className="categories">
          ...
          <div className="category-home">
            <Link
              to={`/filters/mainCategory/fashion`}
              style={{ color: "grey" }}
            >
          ...
          <div className="category-home laptop-margin">
            <Link
              to={`/filters/mainCategory/electronicsAppliances/category/laptopPcGaming/subCategory/laptop`}
              style={{ color: "grey" }}
            >
          ...
          <div className="category-home">
            <Link
              to={`/filters/mainCategory/houseAndGarden/category/furnitureDecorations/subCategory/kitchen`}
              style={{ color: "grey" }}
            >
          ...
          <div className="category-home">
            <Link
              to={`/filters/mainCategory/fashion/category/watches`}
              style={{ color: "grey" }}
            >
          ...
          <div className="category-home toys-margin">
            <Link
              to={`/filters/mainCategory/electronicsAppliances`}
              style={{ color: "grey" }}
            >
